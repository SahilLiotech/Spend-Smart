class AppString {
  // below all the text are used in the onboarding screens.
  static const String onBoardingScreenTitle1 =
      "Track your expenses effortlessly";
  static const String onBoardingScreenTitle2 = "Maximize your savings";
  static const String onBoardingScreenTitle3 = "Export your data";
  static const String onBoardingScreenSubTitle1 =
      "Stay on top of your spending and manage your finances with ease";
  static const String onBoardingScreenSubtitle2 =
      "Take control of your finances and grow your savings with ease";
  static const String onBoardingScreenSubtitle3 =
      "Effortlessly manage, track and export your expenses in one place";
  static const String skip = "Skip";
  static const String getStarted = "Get Started";

  // below all the text are used in the authentication screens.
  static const String createAccount = "Create Account";
  static const String loginHeading = "Log In & Take Control of Your Finances";
  static const String signupHeading =
      "Get Started with Smart Spend - Your Money, Your Control";
